    ...
    <div
        ...
        <div class="row align-items-center">
            ...
            <div class="col-8 text-start">
                <h6 class="text-danger fw-bold m-0 text-center">MASTER OF COMPUTER APPLICATION (MCA)</h6>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul>
                        <li><a href="#" target="_blank">HOD  </a></li>
                        <li><a href="#" target="_blank">Administration team</a></li>
                        <li><a href="#" target="_blank">Committees</a></li>
                        <li><a href="#" target="_blank">Faculty</a></li>
                        <li><a href="#" target="_blank">Students </a></li>
                        <li><a href="#" target="_blank">Labs</a></li>
                        <li><a href="#" target="_blank">Vision Mission</a></li>
                        <li><a href="#" target="_blank">PEO, PO, PSO</a></li>
                        <li><a href="#" target="_blank">Department Video</a></li>
                        <li><a href="#" target="_blank">Gallery  </a></li>
                        <li><a href="#" target="_blank">Student Speak   </a></li>
                        <li><a href="#" target="_blank">E-Magazine  </a></li>
            ...
            <!-- PLACEMENT -->
                <li class="dropdown">
                    ...
                    <ul>
                        ...
                        <li><a href="#" target="_blank">Evaluation Scheme</a></li>                        
                        <li><a href="#" target="_blank">Academic Guest Lecture</a></li>
                        <li><a href="#" target="_blank">Toppers </a></li>
               ...
               <!-- <li><a href="/bim/../index.php">Achievement </a></li>-->
                ...
                <!-- Department socity -->
                <li class="dropdown">
                    <a href="#"><span>Department Society (Leadership)</span><i class="bi bi-chevron-down"></i></a>
                    <ul>
   ...
   <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul>
                        ...
                        <li><a href="#">SD Club </a></li>
                        <li><a href="#">Out campus Participation </a></li>
                        <li><a href="#">MOOCs Course</a></li>
       ...
       <!-- Personality Development -->
                <li class="dropdown">
                    ...
                    <ul>
                            ...
                            <li><a href="#">Notional Conference</a></li>
