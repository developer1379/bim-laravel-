    ...
    <div class="container py-4 d-none d-md-block">
        <div class="row">
            <div class="col-md-1 px-1">
                <center>
                    <a href="{{ url('../bgi') }}">
                        <img src="{{ asset('../images/bgi_logo.png') }}" class="img-fluid w-logo" style="max-width:100% !important;" />
                    </a>
                </center>
            </div>
            ...
            <div class="col-md-1 px-1">
                <center>
                    <a href="{{ url('../bgi') }}" target="_blank">
                        <img src="{{ asset('../images/bgi_logo.png') }}" class="img-fluid w-logo" />
                    </a>
                </center>
            </div>
        </div>
