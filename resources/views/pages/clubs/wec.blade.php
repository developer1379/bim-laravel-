@extends('layouts.site', [
    ...
    'headerPartial' => 'pages.clubs.wec-sidebar',
    'footerPartial' => 'pages.clubs.wec-sidebar',
    'scriptsPartial' => 'pages.clubs.wec-sidebar',
])
...
<?php 
    ...
    <div class="container-fluid" id='main-content'>
        ...
        <div class="row">
            <?php echo view('pages.clubs.wec-sidebar');; ?>
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">

                <?php
                if (isset($_GET['women-empowerment-cell'])) {
                    echo view('pages.clubs.women-empowerment-cell');;
                }
                if (isset($_GET['wec-activities'])) {
                    echo view('pages.clubs.wec-activities');;
                }
