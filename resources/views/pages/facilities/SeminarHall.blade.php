                        ...
                        <div class="w_content">
                            ...
                            <div class="border border-1 p-3 w-content">
                                <div class="section-title">
                                    <h2 class=" text-danger text-center text-uppercase">Seminar Hall</h2>
                                </div>
                                <section class="section m-t-0 w-tj pt-0">

                                    <p class="">BIT has a fully air-conditioned Seminar Hall having state-of-the-art equipment and facilities.</p>
                                </section>
                                <div class="row">
