        ...
        <div class="row">
            ...
            <div class="col-lg-8 bords pt-20 depart-marg">
                <div class="int-container">
                    <h4 class="college-head">Transport</h4>
                    <hr>
                    <div class="er-txt">
                        <p style="text-align: justify;">Institute provides transport facilities for staff and students by the means of six buses, plying between the city and the college. </p>
                    </div>
                    <div class="row">
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('images/hostel/11 (1).jpg') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>
            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('images/hostel/11 (2).jpg') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>
            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('images/hostel/11 (3).jpg') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>
            </div>
        </div>
                </div>
