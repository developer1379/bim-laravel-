...
<body>
    <div class="container py-4">
        <h2 class="text-center mb-4" data-aos="fade-up" data-aos-delay="200">Computer Labs</h2>
        <div class="row g-4">
            <script>
                let galleryHtml = '';
                for (let i = 1; i <= 5; i++) {
                    galleryHtml += `
                        <div class="col-lg-3 col-md-4 col-6" data-aos="fade-up" data-aos-delay="300">
                            <img class="gallery-img" src="{{ asset('images/computer_lab/${i}.jpeg') }}" alt="Gallery Image ${i}" onclick="openModal(this.src)">
                        </div>
                    `;
                }
