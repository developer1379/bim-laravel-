...
<head>
    ...
    <title>AKTU affiliation latter 2023-24 - BIM</title>
...
<body>
    ...
    <div class="pdf-container">
        <embed src="{{ asset('PDF/1 AKTU affiliation latter 2023-24.pdf#toolbar=0') }}" type="application/pdf" width="50%" height="900px" />
    </div>
