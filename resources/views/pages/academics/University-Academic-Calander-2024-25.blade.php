...
<head>
    ...
    <title>University Academic Calander 2024-25 - BIM</title>
...
<body>
    ...
    <div class="pdf-container">
        <embed src="{{ asset('PDF/University Academic Calander 2024-25.pdf#toolbar=0') }}" type="application/pdf" width="50%" height="900px" />
    </div>
