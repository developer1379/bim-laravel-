...
<head>
    ...
    <title>AKTU affiliation latter 2024-25 - BIM</title>
...
<body>
    ...
    <div class="pdf-container">
        <embed src="{{ asset('PDF/EOA_Report_2024-2025PDF_240618_173139.pdf#toolbar=0') }}" type="application/pdf" width="50%" height="900px" />
    </div>
