...
<head>
    ...
    <title>College Academic calander 14-10-24 - BIM</title>
...
<body>
    ...
    <div class="pdf-container">
        <embed src="{{ asset('PDF/College Academic calander 14-10-24.pdf#toolbar=0') }}" type="application/pdf" width="50%" height="900px" />
    </div>
