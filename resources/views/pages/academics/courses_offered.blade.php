...
<body>
    ...
    <div class="container py-4">
       ...
       <div class="row g-4">
        ...
        <img src="{{ asset('images/bgi_courses.jpg') }}" class="img-fluid" alt="Responsive image">
          <!--  <script>
                let galleryHtml = '';
                for (let i = 1; i <= 2; i++) {
                    galleryHtml += `
                        <div class="col-lg-6 col-md-6 col-6" data-aos="fade-up" data-aos-delay="300">
                            <img class="gallery-img" src="{{ asset('Images/courses_offered/${i}.jpeg') }}" alt="Gallery Image ${i}" onclick="openModal(this.src)">
                        </div>
                    `;
                }
