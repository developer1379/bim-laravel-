<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
        <h4 class="fw-bold" data-aos="fade-up" data-aos-delay="300">Activities  </h4>
    ...
    <tr data-aos="fade-up" data-aos-delay="500" class="aos-init">
        <th scope="row">1</th>
        <td>Activities</td>
        <th><a href="https://www.facebook.com/share/p/1BA8Zksn6q/" target="_blank" class="text-decoration-none text-danger">View</a></th>
    </tr>
