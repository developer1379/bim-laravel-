                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">Odd Semester </h2>
                            <h4 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">July – Dec, Session : 2025-26  </h4>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>BIM Academic 1th Sem.</td>
                                                    <td><a href="{{ asset('PDF/1st_BIM_Academic.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>2</td>
                                                    <td>BIM Academic 3rd Sem.</td>
                                                    <td><a href="{{ asset('PDF/3rd_BIM_Academic_MBA.pdf') }}" target="_blank"><button type="button" class="btn btn-danger">View </button></a></td>
                                              </tr>
