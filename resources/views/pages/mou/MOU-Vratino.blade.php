...
<head>
    ...
    <title>MOU Vratino Technologies PVT LTD - BIM</title>
...
<body>
    ...
    <div class="pdf-container">
        <embed src="{{ asset('PDF/MOU Vratino Technologies PVT LTD.pdf#toolbar=0') }}" type="application/pdf" width="50%" height="900px" />
    </div>
