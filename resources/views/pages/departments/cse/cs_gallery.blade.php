        ...
        <div class="row">
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0104.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0105.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0106.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0107.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div> <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0108.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0109.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0110.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0122.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div> <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0112.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0113.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0114.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div>
            <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0115.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>
             ...
             <div class="col-lg-4 col-6">
                ...
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0116.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div> <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0117.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div> <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0118.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div> <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0119.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div> <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0120.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>

            </div> <div class="col-lg-4 col-6">
                <div class="gallery-img">
                    <img src="{{ asset('../../../images/gallery/cs/DSC_0121.JPG') }}" class="img-thumbnail" onclick="onClick(this)">
                </div>
