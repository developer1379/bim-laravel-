         ...
         <li>
            ...
            <div class="col-lg-8 bords pt-20 depart-marg">
                <div class="int-container">
                    <h4 class="college-head">Department of Computer Science </h4>
                    <hr>
                    <div class="er-txt">
                        <h5>AIM OF THE COURSE </h5>
                        <p style="text-align: justify;">Computer Science & Information Technology is about understanding computer systems and networks at a deep level. Computers and the programs they run are among the most complex products ever created; designing and using them effectively presents immense challenges. Facing these challenges is the aim of Computer Science as a practical discipline.</p>
                        <h5>
                            JOB OPPORTUNITIES
                        </h5>
