        ...
        <div id="carouselExampleControls" class="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner h-100">
                <div class="carousel-item active h-100">
                    <img src="{{ asset('../../../images/ca_indu/1.jpg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 1">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/ca_indu/2.jpg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 2">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/ca_indu/3.jpg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 3">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/ca_indu/4.jpg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 4">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/ca_indu/5.jpg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 5">
                </div>
                <!--<div class="carousel-item h-100">
