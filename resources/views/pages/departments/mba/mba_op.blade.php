...
<head>
    ...
    <title>Orientation Program  - MBA</title>
                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">Orientation Program  - MBA </h2>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>2nd Year Student Orientation Program</td>
                                                    <td><a href="{{ asset('../../../PDF/bba_7_2_STUD_ORIENTATION_PROGRAM_NOTICE.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>2</td>
                                                    <td>Student Orientation Program Summary (BBA 4th Sem)</td>
                                                    <td><a href="{{ asset('../../../PDF/bba_7_4_STUD_ORIENTATION_PROGRAM_SUMMARY.pdf') }}" target="_blank"><button type="button" class="btn btn-danger">View </button></a></td>
                                              </tr>
