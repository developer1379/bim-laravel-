...
<head>
    ...
    <title>Industrial Visit Summary - MBA</title>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>Industrial Visit Summary Report </td>
                                                    <td><a href="{{ asset('../../../PDF/Industrial Visit Summary.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
