                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">MBA Workshop  </h2>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>SD guest lecture </td>
                                                    <td><a href="{{ asset('../../../PDF/SD guest lecture.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>1</td>
                                                    <td>Workshop by Er. Veer Shankar </td>
                                                    <td><a href="{{ asset('../../../PDF/Workshop by Er. Veer Shankar.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>1</td>
                                                    <td>Workshop </td>
                                                    <td><a href="{{ asset('../../../PDF/Workshop.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
