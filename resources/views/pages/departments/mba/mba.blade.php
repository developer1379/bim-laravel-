        ...
        <div id="carouselExampleControls" class="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner h-100">
                <div class="carousel-item active h-100">
                    <img src="{{ asset('../../../images/mba_slider/1.jpeg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 1">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/mba_slider/2.jpeg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 2">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/mba_slider/3.jpeg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 3">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/mba_slider/4.jpeg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 4">
                </div>
                <div class="carousel-item h-100">
                    <img src="{{ asset('../../../images/mba_slider/5.jpeg') }}" class="d-block w-100 h-100 object-fit-cover" alt="Image 5">
                </div>
         ...
         <!-- <h1 class="text-center py-4" style="text-transform: uppercase;" data-aos="fade-up" data-aos-delay="300">Social Media</h1>-->
            <div class="row g-3 pb-4 mt-3">
                ...
                <div class="col-md-4 col-12 mt-md-0 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="300">
                    <a href="#"  style="text-decoration: none; color: inherit; width: 100%;">
                ...
                <!--<div class="col-md-3 col-12 mt-5 mt-md-0 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="500">
                    <a href="#" target="_blank" style="text-decoration: none; color: inherit; width: 100%;">
                        <div class="card text-start shadow" style="height: 300px; width:100%;">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide thumbnail">
                    <div class="d-flex justify-content-center" style="height: 350px;">
                      <a href="{{ url('top-placement') }}" target="_blank" class="text-danger">  <img class="img-fluid img-thumbnail img-rounded" src="{{ asset('../../../images/top_placement_bIM/1.jpeg') }}" alt="Error 404 - Image Not Found" style="height: 290px;">

                          <div class="caption">
                             <p style="font-size: 11px; font-weight: 500;"><span>Harshita Srivastava ,</span>
                                <span>MBA , </span>

<span>2024-26,</span>
<span>Deloitte, Gurugram,</span>
<span> Package-18 LPA</span>
                ...
                <div class="swiper-slide thumbnail">
                    <div class="d-flex justify-content-center " style="height: 350px;">
                        <a href="{{ url('top-placement') }}" target="_blank" class="text-danger">  <img class="img-fluid img-thumbnail img-rounded" src="{{ asset('../../../images/top_placement_bIM/2.jpeg') }}" alt="Error 404 - Image Not Found" style="height: 290px;">

                         <div class="caption">
                             <p style="font-size: 11px; font-weight: 500;"><span>Name:Aditya Kumar Singh</span>
<span>Dept: MBA</span>
<span>Batch:2025</span>
<span>Company:India Compressor Ltd</span>
<span>Package:8 LPA</span></p>
                         </div>
                        </a>
                    </div>
                </div>
                <div class="swiper-slide thumbnail">
                    <div class="d-flex justify-content-center " style="height: 350px;">
                        <a href="{{ url('top-placement') }}" target="_blank" class="text-danger">  <img class="img-fluid img-thumbnail img-rounded" src="{{ asset('../../../images/top_placement_bIM/3.jpeg') }}" alt="Error 404 - Image Not Found" style="height: 290px;">

                      <div class="caption">
                             <p style="font-size: 11px; font-weight: 500;"><span>Name:Sneha Pandey</span>
<span>Dept: MBA</span>
<span>Batch:2025</span>
<span>Company:Welspun gcc</span>
<span>Package:6 LPA</span></p>
                         </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="swiper-slide thumbnail">
                    <div class="d-flex justify-content-center " style="height: 350px;">
                        <a href="{{ url('top-placement') }}" target="_blank" class="text-danger">  <img class="img-fluid img-thumbnail img-rounded" src="{{ asset('../../../images/top_placement_bIM/4.jpeg') }}" alt="Error 404 - Image Not Found" style="height: 290px;">
                          <div class="caption">
                           <p style="font-size: 11px; font-weight: 500;"><span>Name:Priya Bhatt</span>
<span>Dept: MBA</span>
<span>Batch:2026</span>
<span>Company:Capgemini</span>
<span>Package:5.5 LPA</span></p>
                         </div>
                ...
                <div class="swiper-slide thumbnail">
                    <div class="d-flex justify-content-center " style="height: 350px;">
                         <a href="{{ url('top-placement') }}" target="_blank" class="text-danger"> <img class="img-fluid img-thumbnail img-rounded" src="{{ asset('../../../images/top_placement_bIM/5.jpg') }}" alt="Error 404 - Image Not Found" style="height: 290px;">

                                <div class="caption">
                               <p style="font-size: 11px; font-weight: 500;"><span>Name:Amit Kumar Dubey</span>
<span>Dept: MBA</span>
<span>Batch:2026</span>
<span>Company:Nikham Innovation Pvt. Ltd.</span>
<span>Package:5.5 LPA</span></p>
                         </div>
                         </a>
                    </div>
                ...
                <div class="swiper-slide thumbnail">
                    <div class="d-flex justify-content-center " style="height: 350px;">
                         <a href="{{ url('top-placement') }}" target="_blank" class="text-danger"> <img class="img-fluid img-thumbnail img-rounded" src="{{ asset('../../../images/top_placement_bIM/6.jpeg') }}" alt="Error 404 - Image Not Found" style="height: 290px;">

                          <div class="caption">
                              <p style="font-size: 11px; font-weight: 500;"><span>Name:Atrish Shukla</span>
<span>Dept: MBA</span>
<span>Batch:2026</span>
<span>Company:Seeds Fincap pvt ltd</span>
<span>Package:4.49 LPA</span></p>
                         </div>
                         </a>
                    </div>
                </div>
        ...
        <a href="https://www.bimgkp.ac.in/mba_top_placement.php" target="_blank"><button type="button" class="btn btn-danger">Go FOR MORE</button></a>
    </div>
...
<!-- achivement-->
<Section class="container">
        <h1 class="text-center pb-4" style="text-transform: uppercase;" data-aos="fade-up" data-aos-delay="300">OUR ACHIEVMENT</h1>
        <div class="row">

            <div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="card text-start shadow border-0" data-aos="fade-up" data-aos-delay="300">
                    <img class="card-img-top img-fluid" style="height:200px; width:100%;" src="{{ asset('../../../images/mba_achiv/1.jpeg') }}" alt="Title" />
                    <div class="card-body text-center">
                        <!--<h5 class="card-title"></h5>
                        <p class="card-text mb-0">B.Tech, M.Tech</p>
                        <p>AKTU Code-525</p>-->
                        <a href="https://www.bimgkp.ac.in/mba_ocp.php" target="_blank" class="btn rounded-pill px-4 py-2 text-light" style="background-color: #d21404;">Go Now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="card text-start shadow border-0" data-aos="fade-up" data-aos-delay="400">
                    <img class="card-img-top img-fluid" style="height:200px; width:100%;" src="{{ asset('../../../images/mba_achiv/2.jpg') }}" alt="Title" />
                    <div class="card-body text-center">
                        <!--<h5 class="card-title">Buddha Institute Of <br>Pharmacy</h5>
                        <p class="card-text mb-0">B.Pharm, D.Pharm</p>
                        <p>AKTU Code-932</p>-->
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="card text-start shadow border-0" data-aos="fade-up" data-aos-delay="500">
                    <img class="card-img-top img-fluid" style="height:200px; width:100%; object-fit: cover;" src="{{ asset('../../../images/mba_achiv/3.jpg') }}" alt="Title" />
                    <div class="card-body text-center">
                       <!-- <h5 class="card-title">Buddha Institute Of Management</h5>
                        <p class="card-text mb-0">MBA, BBA, MCA, BCA</p>
                        <p>AKTU Code-1212</p>-->
                        <a href="https://www.bimgkp.ac.in/mba_ocp.php" class="btn rounded-pill px-4 py-2 text-light" style="background-color: #d21404;">Go Now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="card text-start shadow border-0" data-aos="fade-up" data-aos-delay="600">
                    <img class="card-img-top img-fluid" style="height:200px; width:100%;" src="{{ asset('../../../images/mba_achiv/4.jpeg') }}" alt="Title" />
                    <div class="card-body text-center">
                        <!--<h5 class="card-title">Buddha Institute Of Hotel Management</h5>
                        <p class="card-text mb-0">BHMCT</p>
                        <p>AKTU Code-1197</p>-->
    ...
    <section style="background-color: #fefefe;">
        <div class="container">
            ...
            <div class="row g-3 pb-4 mt-3">
                ...
                <!-- Facebook Card -->
                <div class="col-md-3 col-12 mt-md-0 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="300">
                    <a href="https://www.facebook.com/pinnaclemba/" target="_blank" style="text-decoration: none; color: inherit; width: 100%;">
                        <div class="card text-start shadow" style="height: 300px; width:100%;">
                            <div class="btn text-light py-2" style="margin-top: -20px; background-color:#1877F2;">Facebook</div>
                            <div class="card-body d-flex align-items-center justify-content-center">
                                <p class="text-center">Follow us on Facebook for the latest updates.</p>
                ...
                <!-- YouTube Card with Embedded Video -->
                <div class="col-md-3 col-12 mt-5 mt-md-0 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="400">
                    <div class="card text-start shadow" style="height: 300px; width:100%;">
                        <div class="btn text-light py-2" style="margin-top: -20px; background-color:#FF0000;">YouTube</div>
                        <div class="card-body d-flex align-items-center justify-content-center" style="overflow:hidden;">
                            <!-- Embedded YouTube Video with Autoplay -->
                ...
                <!-- Instagram Card -->
                <div class="col-md-3 col-12 mt-5 mt-md-0 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="500">
                    <a href="https://www.instagram.com/bim_mba.1212?igsh=MXNsbnc3YTR1N2dmNA==" target="_blank" style="text-decoration: none; color: inherit; width: 100%;">
                        <div class="card text-start shadow" style="height: 300px; width:100%;">
                ...
                <div class="col-md-3 col-12 mt-5 mt-md-0 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="500">
                    <a href="https://x.com/bimgkp" target="_blank" style="text-decoration: none; color: inherit; width: 100%;">
                        <div class="card text-start shadow" style="height: 300px; width:100%;">
