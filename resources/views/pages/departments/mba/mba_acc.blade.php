...
<head>
    ...
    <title>Acadmic Calendar - MBA</title>
                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            ...
                            <h3 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">MBA (2nd & 4th Semester) </h3>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>MBA Academic AKTU Calendar</td>
                                                    <td><a href="{{ asset('../../../PDF/AKTU_Academic_Calendar_2025-26.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>2</td>
                                                    <td>MBA Academic College</td>
                                                    <td><a href="{{ asset('../../../PDF/combo_COLLEGE.pdf') }}" target="_blank"><button type="button" class="btn btn-danger">View </button></a></td>
                                              </tr>
