                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">MBA Out campus Participation  </h2>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        <thead>
                                          <tr>
                                            <th>S.N</th>
                                            <th>Out campus Participation </th>
                                            <th>View event  </th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>DDU CONFERENCE ACHIEVEMENT </td>
                                                    <td><a href="{{ asset('../../../PDF/DDU CONFERENCE ACHIEVEMENT.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>2</td>
                                                    <td>OUTCAMPUS ACHIEVEMENT</td>
                                                    <td><a href="{{ asset('../../../PDF/OUTCAMPUS ACHIEVEMENT.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>3</td>
                                                    <td>OUTCAMPUS ACHIEVEMENT at AKTU</td>
                                                    <td><a href="{{ asset('../../../PDF/ocaaktu.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
