                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">Toppers</h2>
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    ...
                                                    <td>2023-25</td>
                                                    <td>77.54</td>
                                                    <td> <img class="img-thumbnail" src="{{ asset('../../../images/mt1.jpeg') }}" alt="toper Image" title="toper" style="width: 18%;"></td>
                                              </tr> 
                                              <tr>
                                                    <td>2</td>
                                                    <td>24121207000182</td>
                                                    <td>Suruchi Yadav</td>
                                                    <td>MBA</td>
                                                    <td>1ST yr</td>
                                                    <td></td>
                                                    <td></td>
                                                    <td>79.01</td>
                                                    <td> <img class="img-thumbnail" src="{{ asset('../../../images/mt2.jpeg') }}" alt="toper Image" title="toper" style="width: 18%;"></td>
                                              </tr> 
                                              <tr>
                                                    <td>3</td>
                                                    <td>2412120700065</td>
                                                    ...
                                                    <td></td>
                                                    <td>79.50</td>
                                                    <td> <img class="img-thumbnail" src="{{ asset('../../../images/mt3.jpeg') }}" alt="toper Image" title="toper" style="width: 18%;"></td>
                                              </tr> 
                                              <tr>
                                                    <td>4</td>
                                                    <td>2412120700000</td>
                                                    ...
                                                    <td></td>
                                                    <td>78.90</td>
                                                    <td> <img class="img-thumbnail" src="{{ asset('../../../images/mt4.jpeg') }}" alt="toper Image" title="toper" style="width: 18%;"></td>
                                              </tr> 
