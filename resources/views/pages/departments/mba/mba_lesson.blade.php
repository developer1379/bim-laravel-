                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>MBA LESSON PLAN-COMBINED </td>
                                                    <td><a href="{{ asset('../../../PDF/MBA -COMPILED LESSON PLAN-2 SEM..pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>2</td>
                                                    <td>MBA 4th Sem.</td>
                                                    <td><a href="{{ asset('../../../PDF/MBA-COMPILED LESSON PLAN-4 SEM..pdf') }}" target="_blank"><button type="button" class="btn btn-danger">View </button></a></td>
                                              </tr>
