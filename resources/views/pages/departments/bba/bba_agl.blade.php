...
<head>
    ...
    <title>Academic Guest Lecture - BBA</title>
                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">Academic Guest Lecture </h2>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>REPORT OF THE EVENT ACADEMIC GUEST LECTURE</td>
                                                    <td><a href="{{ asset('../../../PDF/BBA_guest_ltc.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>1</td>
                                                    <td>Guest Lecture on “What’s Trending in Finance as a Career Goal”</td>
                                                    <td><a href="{{ asset('../../../PDF/Guest Lecture on What’s Trending in Finance as a Career Goal.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
