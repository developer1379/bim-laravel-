...
$sql = "SELECT * FROM `bba_faculty_details` LIMIT 1 OFFSET 1";
...
<div class="row">
    <div class="col-md-3 col-lg-3 col-sm-4 col-12">
        <img src="{{ asset('../../../Images/rrp.png') }}" class="mb-4 w-100" data-aos="fade-up" data-aos-delay="400" />
    </div>
        ...
        <table class="table table-bordered" data-aos="fade-up" data-aos-delay="500">
            <thead>
                <tr data-aos="fade-up" data-aos-delay="300">
                    ...
                    <td scope="col"><!--<?php echo $row['name']; ?>--> Dr. Rama Raman Pandey</td>
                </tr>
            </thead>
            <tbody>
                <tr data-aos="fade-up" data-aos-delay="400">
                    <th scope="row">Designation</th>
                    <td><!--<?php echo $row['designation']; ?>--> HOD</td>
                </tr>
                <tr data-aos="fade-up" data-aos-delay="500">
                    <th scope="row">Department</th>
                    <td><?php echo $row['department']; ?> BBA</td>
                </tr>
            </tbody>
        </table>
    </div>
