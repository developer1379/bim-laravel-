...
<head>
    ...
    <title>BBA Student list - BIM</title>
...
<h3 class="text-center text-danger">BBA Student List</h3>
<hr>

    <div class="pdf-container">
        <embed src="{{ asset('../../../PDF/BBA_Student_list.pdf#toolbar=0') }}" type="application/pdf" width="50%" height="900px" />
    </div>
