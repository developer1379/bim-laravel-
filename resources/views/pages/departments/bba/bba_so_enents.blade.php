...
<head>
    ...
    <title>BBA Events- Gallery</title>
...
<body>
    <div class="container py-4">
        <h3 class="text-center mb-4 text-uppercase" data-aos="fade-up" data-aos-delay="200">BBA Events</h3>
                ...
                for (let i = 1; i <=8; i++) {
                    galleryHtml += `
                        <div class="col-lg-3 col-md-4 col-6" data-aos="fade-up" data-aos-delay="300">
                            <img class="gallery-img" src="{{ asset('../../../Images/bba_events/${i}.jpeg') }}" alt="Gallery Image ${i}" onclick="openModal(this.src)">
                        </div>
                    `;
                }
