...
<head>
    ...
    <title>Industrial Visit Summary - BBA</title>
                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">Industrial Visit Summary  </h2>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>Industrial Visit Notice </td>
                                                    <td><a href="{{ asset('../../../PDF/notice_bba_iv.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>

                                              <tr>
                                                    <td>2</td>
                                                    <td>Industrial Visit Summary </td>
                                                    <td><a href="{{ asset('../../../PDF/Industrial Visit Summary 2.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
