                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>BBA 2nd Sem.</td>
                                                    <td><a href="{{ asset('../../../PDF/bba_2th sem merge pdf.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>2</td>
                                                    <td>BBA 4th Sem.</td>
                                                    <td><a href="{{ asset('../../../PDF/bba_4th sem merge pdf.pdf') }}" target="_blank"><button type="button" class="btn btn-danger">View </button></a></td>
                                              </tr>
