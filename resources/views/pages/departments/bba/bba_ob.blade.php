...
<body>
   ...
   <div class="row g-4">
        ...
        <img src="{{ asset('../../../Images/bba_meeting_Cr.jpg') }}" class="img-fluid" alt="Responsive image">
    </div>
   ...
   <div class="row g-4">
        ...
        <img src="{{ asset('../../../Images/bba_4th_meeting_cr.jpg') }}" class="img-fluid" alt="Responsive image">
    </div>
