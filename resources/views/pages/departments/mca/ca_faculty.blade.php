...
<head>
    ...
    <title>CA Administrative Committee</title>
...
<body>
    ...
    <!-- Carousel Start -->
     <row> <h4 class="text-danger text-center"> Department Faculty List</h4></row>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Mr. Shri Kant Mani Tripathi </td>
    </tr>
     <tr>
      <th scope="row">4</th>
