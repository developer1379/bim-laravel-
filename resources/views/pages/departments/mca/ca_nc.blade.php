...
<head>
    ...
    <title>National Confrance - CA</title>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>National Confrance</td>
                                                    <td><a href="{{ asset('../../../PDF/Summary-Conference 8-9 April (1).pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
