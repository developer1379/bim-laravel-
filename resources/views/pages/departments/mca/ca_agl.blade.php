...
<head>
    ...
    <title>Academic Guest Lecture - CA</title>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>Academic Guest Lecture</td>
                                                    <td><a href="{{ asset('../../../PDF/Guest Lecture  External WORKSHOP_SUMMARY.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
