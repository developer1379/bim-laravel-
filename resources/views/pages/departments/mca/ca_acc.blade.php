...
<head>
    ...
    <title>Acadmic Calendar - CA</title>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>CA Academic 2th Sem.</td>
                                                    <td><a href="{{ asset('../../../PDF/1. Academic calander.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
                                              <tr>
                                                    <td>2</td>
                                                    <td>CA Academic 4th Sem.</td>
                                                    <td><a href="{{ asset('../../../PDF/1. Academic calander.pdf') }}" target="_blank"><button type="button" class="btn btn-danger">View </button></a></td>
                                              </tr>
