                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>COMPUTER APPLICATION E-MAGAZINE</td>
                                                    <td><a href="{{ asset('../../../PDF/CA_Magazin 2026.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
