...
<head>
    ...
    <title>Orientation Program  - CA</title>
                ...
                <div class="w_content">
                    <div class=" border border-0 p-3 ">
                        <div class="section-title">
                            <h2 class=" text-danger text-center" data-aos="fade-up" data-aos-delay="300">Orientation Program  - CA </h2>
                            ...
                            <div class="co-md-12">
                               ...
                               <table class="table table-striped">
                                        ...
                                        <tbody>
                                              <tr>
                                                    <td>1</td>
                                                    <td>BCA Student Orientation Program</td>
                                                    <td><a href="{{ asset('../../../PDF/BCA. ORIENTATION_PROGRAM_SUMMARY.pdf') }}" target="_blank"><button type="button" class="btn btn-danger "> View </button></a></td>
                                              </tr>
