                ...
                <div class="mb-30">
                    <nav>
                        <div class="nav nav-tabs text-uppercase  d-flex bd-highlight" id="nav-tab" role="tablist">
                            <button class="nav-link active tablinks flex-fill bd-highlight col" onclick="openCity(event, 'ec')" id="defaultOpen">Electronics & Communication Engineering</button>
                        </div>
                    </nav>
            ...
            <div class="col-lg-8 bords pt-20 depart-marg">
                <div class="int-container">
                    ...
                    <div class="er-txt">
                        ...
                        <p style="text-align: justify;">With the evolution of the computer age, E&C has crept into every sphere of human life, thus increasing its scope manifolds. Electronics is now a part of our everyday life, from your pocket FM radio to televisions, computers, mobile phones and even the high-end satellites. This was an overview on E&C and so our department aims at  training students in the areas of electronics like Solid State Circuits, VLSI, Electronic Controls and Communications Engineering including , Multiple Access Technology and Microwave Engineering.

In order to keep pace with the current technological trends, the department has a well designed, constantly reviewed syllabus to incorporate all advancements in existing and emerging technologies which give the students a holistic and pragmatic view of the present scenario of the Electronics and Communication industry.</p>
                        <h5>
                            JOB OPPORTUNITIES
                        </h5>
